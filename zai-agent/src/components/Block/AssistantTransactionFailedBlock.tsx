...
const AssistantTransactionFailedBlock: React.FC<Props> = ({token}) => {
  ...
  return (
      <div className="bg-white border border-b-normal rounded-2xl pb-3 px-3 pt-4 w-full shadow-border-message">
        ...
        <div className="flex row mt-2.5">
          <Image className="mr-3 rounded-24px w-8 h-8" width={32} height={32} src={token.img} alt={""}/>
...
export default AssistantTransactionFailedBlock;
